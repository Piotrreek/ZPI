...
- [ELP-23](https://zpi-recruitment.atlassian.net/browse/ELP-23) Auto-Verify Quests via GitHub Webhooks ("Smart Check")
...
- **EPIC** [ELP-3](https://zpi-recruitment.atlassian.net/browse/ELP-3) Gamified Onboarding & Development (MVP) [39]
  ...
  - **STORY** [ELP-23](https://zpi-recruitment.atlassian.net/browse/ELP-23) Auto-Verify Quests via GitHub Webhooks ("Smart Check") [13]
    ...
    - [ELP-27](https://zpi-recruitment.atlassian.net/browse/ELP-27) Implement notification to employee (Slack/Teams)
...
### 1. Brak odpowiednich uprawnień Azure do rejestracji aplikacji (App Registration)

- **Zadanie zależne**: ELP-48
- **Problem**: SSO jest podstawową metodą uwierzytelniania zaplanowaną dla projektu
- **Plan zapobiegawczy:** Konsultacja z działem IT w pierwszym dniu projektu lub przygotowanie lokalnego serwera Mock-OIDC do testów.

### 2. Odrzucenie aplikacji deweloperskiej przez LinkedIn (brak dostępu do `Member Share API`)

- **Zadanie zależne**: ELP-41
- **Problem**: Automatyzacja działania na LinkedIn jest podstawą Employer Branding
- **Plan zapobiegawczy:** Natychmiastowe złożenie wniosku o dostęp do **LinkedIn Marketing Developer Platform**. Jako plan awaryjny – testowanie na API profilu osobistego zamiast firmowego.
